<?php
    ...
    curl_setopt($ch, CURLOPT_URL,"https://api.github.com/repos/".trim($_POST["full_name"]));
    curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "PATCH");
    curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($RepoUpdate));
...
<body>
    <main>
        ...
        <h3>Repository Updated successfully...</h3><br><br>
        <a style = "background: #119822; border:none;" role = "button" href="show.php?full_name=<?= $response['full_name']?>">Show the Updated Repo</a>
       ...
       <?php if(in_array($StatusCode , $ErrorCodes)):?>
        <h1>Repository is not Updated successfully...</h1><br><br>
        <?php require "BackToHomePage.php"?>
